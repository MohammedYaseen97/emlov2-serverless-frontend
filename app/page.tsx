...
const CONFIG = {
  "backend_url": "https://zcy2om8g4a.execute-api.us-west-2.amazonaws.com/dev/inference"
}
    ...
    <div className="flex min-h-screen flex-col items-center justify-center py-2">
      <main className="flex w-full flex-1 flex-col items-center justify-center px-20 text-center">
        ...
        <div className="mt-10 text-lg">
          Select a JPG Image from <a href="https://github.com/RubixML/CIFAR-10/tree/master/test" target="_blank" className='text-blue-600'>Example</a>
        </div>
      ...
      <footer className="flex h-24 w-full items-center justify-center border-t">
        ...
        >
          Mohammed Yaseen Maniyar Assignment 09 - EMLO 2.0 🤖 The School of AI
        </a>
      </footer>
    </div>
  )
